...
# título
st.title("Indicação de Investimento em Startup")

# subtítulo
st.markdown("Este é um Aplicativo desenvolvido por Angélica Barros como projeto da Jornada Ciência de Dados e utilizado para exibir a solução de Ciência de Dados para o problema de Investimentos em Startups em Venture Capital.")
